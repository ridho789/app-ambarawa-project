...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">Data Kategori Material</h3>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header border-0 mx-2" style="margin-bottom: -25px;">
                        <h5 class="modal-title" id="kategoriModal">
                            <span class="fw-light"> Data</span>
                            <span class="fw-mediumbold"> Kategori Material Baru </span>
                        </h5>
                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="{{ url('kategori_material-store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
        ...
        <!-- Modal Edit data -->
        <div class="modal fade" id="kategoriEditModal" tabindex="-1" role="dialog" aria-labelledby="kategoriEditModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header border-0 mx-2" style="margin-bottom: -25px;">
                        <h5 class="modal-title" id="kategoriEditModal">
                            <span class="fw-light"> Data</span>
                            <span class="fw-mediumbold"> Kategori Material </span>
                        </h5>
                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="{{ url('kategori_material-update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <p class="small mx-2">
                            ...
                            <div class="form-group">
                                <label for="nama">Nama (Kategori Material)</label>
                                <input type="text" class="form-control" name="nama" id="edit-nama" placeholder="Masukkan nama kategori material.." 
                                oninput="this.value = this.value.toUpperCase()" required />
                            </div>
                        </div>
                        <div class="modal-footer border-0 mx-2">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <div class="card-title">List Kategori Material</div>
                            <button id="editButton" class="btn btn-warning btn-round ms-5 btn-sm" data-bs-toggle="modal" data-bs-target="#kategoriEditModal" style="display: none;">
                                <i class="fa fa-edit"></i>
                                 Edit data
                            </button>
                            <form id="deleteForm" method="POST" action="{{ url('kategori_material-delete') }}" class="d-inline">
                                @csrf
                            ...
                            <button class="btn btn-primary btn-round ms-auto btn-sm" data-bs-toggle="modal" data-bs-target="#kategoriModal">
                            ...
                            <table id="basic-datatables" class="display table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-xxs-bold">Nama (Kategori Material)</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach($kategori as $s)
                                    <tr data-id="{{ $s->id_kategori }}" 
                                        data-nama="{{ $s->nama }}">
