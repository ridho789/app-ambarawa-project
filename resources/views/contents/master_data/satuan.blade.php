...
<div class="container">
    <div class="page-inner">
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header border-0 mx-2" style="margin-bottom: -25px;">
                        <h5 class="modal-title" id="satuanModal">
                            <span class="fw-light"> Data</span>
                            <span class="fw-mediumbold"> Satuan Baru </span>
                        </h5>
                    ...
                    <form action="{{ url('satuan-store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama" id="nama" placeholder="Masukkan nama satuan.." 
        ...
        <!-- Modal Edit data -->
        <div class="modal fade" id="satuanEditModal" tabindex="-1" role="dialog" aria-labelledby="satuanEditModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header border-0 mx-2" style="margin-bottom: -25px;">
                        <h5 class="modal-title" id="satuanEditModal">
                            <span class="fw-light"> Data</span>
                            <span class="fw-mediumbold"> Satuan </span>
                        </h5>
                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="{{ url('satuan-update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <p class="small mx-2">
                            ...
                            <input type="hidden" id="edit-id" name="id_satuan">
                            <input type="hidden" id="edit-user" name="user" value="{{ auth()->user()->name }}">
                            <input type="hidden" name="page" value="{{ request()->get('page', 1) }}">

                            <div class="form-group">
                                <label for="nama">Nama (Satuan)</label>
                                <input type="text" class="form-control" name="nama" id="edit-nama" placeholder="Masukkan nama satuan.." 
                                oninput="this.value = this.value.toUpperCase()" required />
                            </div>
                        </div>
                        <div class="modal-footer border-0 mx-2">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <div class="card-title">List satuan</div>
                            <button id="editButton" class="btn btn-warning btn-round ms-5 btn-sm" data-bs-toggle="modal" data-bs-target="#satuanEditModal" style="display: none;">
                                <i class="fa fa-edit"></i>
                                 Edit data
                            </button>
                            <form id="deleteForm" method="POST" action="{{ url('satuan-delete') }}" class="d-inline">
                                @csrf
                            ...
                            <button class="btn btn-primary btn-round ms-auto btn-sm" data-bs-toggle="modal" data-bs-target="#satuanModal">
                            ...
                            <table id="basic-datatables" class="display table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-xxs-bold">Nama (Satuan)</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach($satuan as $s)
                                    <tr data-id="{{ $s->id_satuan }}" 
                                        data-nama="{{ $s->nama }}">
