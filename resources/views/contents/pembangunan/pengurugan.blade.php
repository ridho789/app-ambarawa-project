                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <form id="statusPendingForm" method="POST" action="{{ url('pengurugan-status_pending') }}" class="d-inline">
                                @csrf
                            ...
                            <form id="statusProcessForm" method="POST" action="{{ url('pengurugan-status_process') }}" class="d-inline">
                                @csrf
                            ...
                            <form id="statusPaidForm" method="POST" action="{{ url('pengurugan-status_paid') }}" class="d-inline">
                                @csrf
                            ...
                            <table id="basic-datatables" class="display table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr data-id="{{ $p->id_pembangunan }}" 
                                        ...
                                        @if ($p->file)
                                            <td>
                                                <a href="{{ asset('storage/' . $p->file) }}" target="_blank">{{ $p->nama ?? '-' }}</a>
                                            </td>
                                        @else
                                            <td>{{ $p->nama ?? '-' }}</td>
                                        @endif
