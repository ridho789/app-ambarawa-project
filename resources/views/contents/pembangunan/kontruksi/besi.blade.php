...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">Data Pengeluaran Besi</h3>
        ...
        <!-- Modal Tambah data -->
        <div class="modal fade" id="besiModal" tabindex="-1" role="dialog" aria-labelledby="besiModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header border-0 mx-2" style="margin-bottom: -25px;">
                        <h5 class="modal-title" id="besiModal">
                            <span class="fw-light"> Data</span>
                            <span class="fw-mediumbold"> Pengeluaran Besi Baru </span>
                        </h5>
                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="{{ url('besi-store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
        ...
        <!-- Modal Edit data -->
        <div class="modal fade" id="besiEditModal" tabindex="-1" role="dialog" aria-labelledby="besiEditModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header border-0 mx-2" style="margin-bottom: -25px;">
                        <h5 class="modal-title" id="besiEditModal">
                            <span class="fw-light"> Data</span>
                    ...
                    <form action="{{ url('besi-update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <p class="small mx-2">
                            ...
                            <input type="hidden" id="edit-id" name="id_besi">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <div class="card-title">List Pengeluaran Besi</div>
                            <input type="hidden" id="allSelectRow" name="ids" value="">
                            <button id="editButton" class="btn btn-warning btn-round ms-5 btn-sm" data-bs-toggle="modal" data-bs-target="#besiEditModal" style="display: none;">
                                <i class="fa fa-edit"></i>
                                Edit data
                            </button>
                            <form id="deleteForm" method="POST" action="{{ url('besi-delete') }}" class="d-inline">
                                @csrf
                            ...
                            <form id="statusPendingForm" method="POST" action="{{ url('besi-status_pending') }}" class="d-inline">
                                @csrf
                            ...
                            <form id="statusProcessForm" method="POST" action="{{ url('besi-status_process') }}" class="d-inline">
                                @csrf
                            ...
                            <form id="statusPaidForm" method="POST" action="{{ url('besi-status_paid') }}" class="d-inline">
                                @csrf
                            ...
                            <table id="basic-datatables" class="display table table-hover">
                                ...
                                <tbody>
                                    ...
                                    data-file="{{ $b->file }}">
                                        ...
                                        <td>{{ $b->tanggal ? \Carbon\Carbon::createFromFormat('Y-m-d', $b->tanggal)->format('d-M-Y') : '-' }}</td>
                                        @if ($b->file)
                                            <td>
                                                <a href="{{ asset('storage/' . $b->file) }}" target="_blank">{{ $b->nama ?? '-' }}</a>
                                            </td>
                                        @else
                                            <td>{{ $b->nama ?? '-' }}</td>
                                        @endif
