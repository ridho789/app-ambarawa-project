...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">Data Pengeluaran Batu</h3>
        ...
        <!-- Modal Tambah data -->
        <div class="modal fade" id="batuModal" tabindex="-1" role="dialog" aria-labelledby="batuModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header border-0 mx-2" style="margin-bottom: -25px;">
                        <h5 class="modal-title" id="batuModal">
                            <span class="fw-light"> Data</span>
                            <span class="fw-mediumbold"> Pengeluaran Batu Baru </span>
                        </h5>
                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="{{ url('batu-store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control" name="nama" id="nama" placeholder="Masukkan nama.." value="Batu" required />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="text" class="form-control" name="satuan" id="satuan" value="rit" placeholder="Masukkan satuan.." required />
                                </div>
                                <div class="col-4">
        ...
        <!-- Modal Edit data -->
        <div class="modal fade" id="batuEditModal" tabindex="-1" role="dialog" aria-labelledby="batuEditModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header border-0 mx-2" style="margin-bottom: -25px;">
                        <h5 class="modal-title" id="batuEditModal">
                            <span class="fw-light"> Data</span>
                            <span class="fw-mediumbold"> Pengeluaran Batu </span>
                        </h5>
                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="{{ url('batu-update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <p class="small mx-2">
                            ...
                            <input type="hidden" id="edit-id" name="id_batu">
        ...
        <!-- Modal Export data -->
        <div class="modal fade" id="batuExportModal" tabindex="-1" role="dialog" aria-labelledby="batuExportModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header border-0 mx-2" style="margin-bottom: -25px;">
                        <h5 class="modal-title" id="batuExportModal">
                    ...
                    <form action="{{ url('batu-export') }}" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                        @csrf
                        <div class="modal-body">
                            <p class="small mx-2">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <div class="card-title">List Pengeluaran Batu</div>
                            <button id="editButton" class="btn btn-warning btn-round ms-5 btn-sm" data-bs-toggle="modal" data-bs-target="#batuEditModal" style="display: none;">
                                <i class="fa fa-edit"></i>
                                Edit data
                            </button>
                            <form id="deleteForm" method="POST" action="{{ url('batu-delete') }}" class="d-inline">
                                @csrf
                            ...
                            <div class="ms-auto d-flex align-items-center">
                                @if (count($batu) > 0)
                                    <button class="btn btn-success btn-round ms-2 btn-sm" data-bs-toggle="modal" data-bs-target="#batuExportModal">
                                        <i class="fa fa-file-excel"></i>
                                        Export data
                                    </button>
                                @endif
                                <button class="btn btn-primary btn-round ms-3 btn-sm" data-bs-toggle="modal" data-bs-target="#batuModal">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="basic-datatables" class="display table table-hover">
                                ...
                                <tbody>
                                    @foreach($batu as $b)
                                    <tr data-id="{{ $b->id_pembangunan }}" 
                                    data-tanggal="{{ $b->tanggal }}" 
                                    data-proyek="{{ $b->id_proyek }}"
                                    data-nama="{{ $b->nama }}" 
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let hargaBatu = document.querySelectorAll("#harga, #edit-harga");
        ...
        hargaBatu.forEach(function(hargaSm, index) {
