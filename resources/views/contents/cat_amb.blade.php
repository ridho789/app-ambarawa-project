...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">Data Pengeluaran Cat</h3>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header border-0 mx-2" style="margin-bottom: -25px;">
                        <h5 class="modal-title" id="catModal">
                            <span class="fw-light"> Data</span>
                            <span class="fw-mediumbold"> Pengeluaran Cat Baru </span>
                        </h5>
        ...
        <!-- Modal Edit Data -->
        <div class="modal fade" id="catEditModal" tabindex="-1" role="dialog" aria-labelledby="catEditModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header border-0 mx-2" style="margin-bottom: -25px;">
                        <h5 class="modal-title" id="catEditModal">
                            <span class="fw-light"> Data</span>
                            <span class="fw-mediumbold"> Pengeluaran Cat </span>
                        </h5>
                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="{{ url('cat-update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <p class="small mx-2">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-4">
                                    <label for="kode_unit">Kode Unit</label>
                                    <input type="text" class="form-control" name="kode_unit" id="edit-kode_unit" placeholder="Masukkan kode unit.." required />
                                </div>
                                <div class="col-4">
                                    <label for="merk">Merk</label>
                                    <input type="text" class="form-control" name="merk" id="edit-merk" placeholder="Masukkan merk.." required />
                                </div>
                            </div> -->
        ...
        <!-- Modal Export data -->
        <div class="modal fade" id="catExportModal" tabindex="-1" role="dialog" aria-labelledby="catExportModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header border-0 mx-2" style="margin-bottom: -25px;">
                        <h5 class="modal-title" id="catExportModal">
                    ...
                    <form action="{{ url('cat-export') }}" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                        @csrf
                        <div class="modal-body">
                            <p class="small mx-2">
                    ...
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-auto d-flex align-items-center">
                                ...
                                @endif
                                <button class="btn btn-primary btn-round ms-3 btn-sm" data-bs-toggle="modal" data-bs-target="#catModal">
                            ...
                            <table id="basic-datatables" class="display table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr data-id="{{ $c->id_tagihan_amb }}" 
                                        ...
                                        data-no_inventaris="{{ $c->no_inventaris }}"
                                        data-nama="{{ $c->nama }}"
                                        data-kategori="{{ $c->kategori }}"
                                        data-dipakai_untuk="{{ $c->dipakai_untuk }}"
                                        data-masa_pakai="{{ $c->masa_pakai }}"
                                        data-jml="{{ $c->jml }}"
                                        data-unit="{{ $c->unit }}"
                                        data-harga="{{ 'Rp ' . number_format($c->harga ?? 0, 0, ',', '.') }}"
                                        data-harga_online="{{ 'Rp ' . number_format($c->harga_online ?? 0, 0, ',', '.') }}"
                                        data-diskon_ongkir="{{ 'Rp ' . number_format($c->diskon_ongkir ?? 0, 0, ',', '.') }}"
                                        data-ongkir="{{ 'Rp ' . number_format($c->ongkir ?? 0, 0, ',', '.') }}"
                                        data-asuransi="{{ 'Rp ' . number_format($c->asuransi ?? 0, 0, ',', '.') }}"
